		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#legacymediopago-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"legacymediopago-display": {
								"semanticObject": "legacymediopago",
								"action": "display",
								"description": "A Legacy application.",
								"title": "Medios de Pago",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=legacy.mediopago",
									"url": sap.ui.require.toUrl("legacy/mediopago")
								}
							}
						}
					}
